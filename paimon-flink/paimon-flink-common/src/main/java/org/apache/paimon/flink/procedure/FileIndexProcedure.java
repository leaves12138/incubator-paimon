...
public class FileIndexProcedure extends ProcedureBase {
    ...
    public String[] call(
            ProcedureContext procedureContext, String partitions, String sourceTablePath)
            throws Exception {
        return call(procedureContext, sourceTablePath, partitions, "");
    }
    ...
    public String[] call(
        ...
        Map<String, String> tableConf = parseCommaSeparatedKeyValues(tableOptions);
        ...
        TopoBuilder.build(env, (FileStoreTable) table.copy(tableConf), partitionPredicate);
